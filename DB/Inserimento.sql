...
VALUES
('Primitivo Doppio Passo 2022', 8.50, 22, "Il Primitivo Doppio Passo è un vino rosso del Salento dal profilo morbido e rotondo.'", 'immagini/1.jpg', 35, 13.0, 75, 'Puglia (Italia)','Vini Rossi', 2022, "Salento IGT"),
("Cannonau 'Mamuthone' Sedilesu", 19.20, 22, "Il Cannonau 'Mamuthone' di Sedilesu è un vino rosso di grande struttura, invecchiato in botte per 12 mesi.", "immagini/2.jpg", 67, 14.5 , 75, "Sardegna (Italia)", 'Vini Rossi', 2021, "Cannonau sardegna DOC"),  
('Tignanello Antinori', 235.00, 22, "Il Tignanello di Antinori è un grande vino toscano, corposo e intenso, di grande eleganza e consistenza, prodotto da uve di Sangiovese, Cabernet Franc e Cabernet Sauvignon, affinato per almeno 12 mesi in barrique.", 'immagini/3.jpg', 9, 13.5, 75, 'Toscana (Italia)','Vini Rossi', 2012, "Toscana IGT"),
("Barolo 'Otin Fiorin - Piè Rupestris' Cappellano", 250.10, 22, "Il Barolo 'Otin Fiorin - Piè Rupestris' è un vino robusto, austero e complesso, nato da viti molto vecchie del cru Gabutti di Serralunga. ", 'immagini/4.jpg', 8, 14.0, 75, 'Piemonte (Italia)','Vini Rossi', 2019, "Barolo DOCG"),
('Kairos Zymé 2019', 74.00, 22,"Il Kairos è un vino rosso robusto e molto intenso, affinato per 36 mesi in barrique e ottenuto dall'assemblaggio di 15 vitigni, di cui 11 a bacca rossa", 'immagini/5.jpg', 25, 15.0, 75, 'Veneto (Italia)','Vini Rossi', 2019, "Veneto IGT"),
('Insoglio del Cinghiale Campo di Sasso', 20.90, 22, "L’Insoglio del Cinghiale è un vino rosso che esprime l’anima indomita della Maremma e che si abbina alla perfezione ai piatti tipici della cucina toscana. ", 'immagini/6.jpg', 75, 14.0, 75, 'Toscana (Italia)','Vini Rossi', 2022, "Toscana IGT"),
("Barbera d'Asti 'Tasmorcan' Elio Perrone", 11.50, 22, "La Barbera d’Asti “Tasmorcan” è un vino rosso di grande tipicità territoriale che colpisce per il carattere morbido e fresco.", 'immagini/7.jpg', 105, 14.5, 75, 'Piemonte (Italia)','Vini Rossi', 2023, "Barbera d'Asti DOCG"),
("'Casa e Chiesa' Tenuta Lenzini 2023", 13.50, 22, " Un succo godibile e fresco, vinificato in acciaio e in cemento capace di regalare un sorso artigianale e rustico, sincero e appagante, intersecato da venature saline ed ematiche che ne amplificano la naturale forza gastronomica.", 'immagini/8.jpg', 104, 14.0, 75, 'Toscana (Italia)','Vini Rossi', 2023, "Colline Lucchesi DOC "),
("Rioja 'El Marujo' Joven Organico Señorio De Librares", 11.50, 22, "El Marujo Joven Organico Señorio De Librares è un vino rosso spagnolo a base di Tempranillo, prodotto da uve biologiche coltivate nella regione di La Rioja", 'immagini/9.jpg', 55, 13.5, 75, 'La Rioja (Spagna)','Vini Rossi', 2022, "Rioja IGT"),
('Rosso Piceno Aurora 2022', 10.50, 22, "Il Rosso Piceno della cantina Aurora è un vino ottenuto da fermentazione spontanea delle uve. Al naso si avvertono vivaci frutti rossi, di sottobosco e in confettura, spezie, caffè e tabacco.", 'immagini/10.jpg', 67, 13.5, 75, 'Marche (Italia)','Vini Rossi', 2022, "Rosso Piceno DOC"),
('Taurasi Feudi di San Gregorio 2019', 21.50, 22, "Il Taurasi di Feudi di San Gregorio è un vino rosso irpino pieno e intenso, affinato per 18 mesi in barrique e 9 mesi in bottiglia. ", 'immagini/11.jpg', 75, 14.0, 75, 'Campania (Italia)','Vini Rossi', 2019, "Taurasi DOCG"),
("Taurasi 'Fren' Stefania Barbot", 38.50, 22, "Il Taurasi 'Fren' è un vino rosso corposo e molto intenso che matura per 2 anni in botti di quercia. Si esprime su ampi sentori di frutta rossa scura matura, spezie dolci, prugna e piacevoli sensazioni di tabacco e cacao.", 'immagini/12.jpg', 15, 14.5, 75, 'Campania (Italia)','Vini Rossi', 2019, "Taurasi DOCG");

-- VINI BIANCHI
INSERT INTO prodotto (nome, prezzo, iva, descrizione, immagine, stock, alcol, formato, provenienza, tipologia, annata, denominazione)
VALUES
("Vermentino 'Costamolino' Argiolas 2023", 10.50, 22, "Il Vermentino 'Costamolino' è una delle etichette più conosciute della cantina Argiolas. E' un vino bianco dal sapore fruttato e fresco. ", 'immagini/13.jpg', 80, 14.0, 75, 'Alto Adige (Italia)', 'Vini Bianchi', 2023, 'Vermentino di Sardegna DOC'),
("'Pfefferer' Colterenzio 2023", 10.90, 22, 'Si tratta di un bianco fruttato e speziato, dalla trama elegante e suadente, sostenuta da una energizzante freschezza..', 'immagini/14.jpg', 80, 12.5, 75, 'Alto Adige (Italia)', 'Vini Bianchi', 2023, 'Alto Adige/Sudtirol DOC'),
...
("Trebbiano d'Abruzzo Emidio Pepe 2007", 250.20, 22, 'Vino bianco di notevole espressione. Di bella complessità al naso, elegante, dai sentori di frutta accarezzatada sentori marini e in confettura.', 'immagini/16.jpg', 7, 12.0, 75, 'Abruzzo (Italia)', 'Vini Bianchi', 2007, "Trebbiano d'Abruzzo DOC"),
...
("Puligny Montrachet 'Les Charmes'", 145.00, 22, 'Un elegante vino bianco di Borgogna a base di Chardonnay, affinato per 16 mesi in barrique. Ricco, avvolgente e pieno al palato, dal finale minerale e leggermente speziato', 'immagini/18.jpg', 21, 13.0, 75, 'Borgogna (Francia)', 'Vini Bianchi', 2021, 'Puligny Montrachet AOC'),
("Lugana 'I Frati' Ca' dei Frati 2023", 12.50, 22, "Il fiore all'occhiello della cantina Ca' dei Frati. Pienamente espressivo delle caratteristiche della Turbiana, si offre con una personalità fresca, delicata ed elegante", 'immagini/19.jpg', 84, 13.0, 75, 'Lombardia (Italia)', 'Vini Bianchi', 2023, 'Lugana DOC'),
...
("Sancerre Blanc 'Origine' Matthias et Emile Roblin 2022", 21.60, 22, "E' un Sancerre Blanc che esprime in maniera eccellente l'unicità del terrorir della Valle della Loira orientale. Un Sauvignon dal profilo organolettico erbaceo e fruttato, dai toni verdi e agrumati e dal sorso dritto e vivido", 'immagini/21.jpg', 65, 13.0, 75, 'Valle della Loira ( Francia )', 'Vini Bianchi', 2022, 'Sancerre AOC'),
('Piccolo Derthona Vigneti Massa 2023', 14.0, 22, 'Il Piccolo Derthona di Vigneti Massa è un vino bianco piacevole e fresco provenienti da uve bianche cresciute a 300 metri di altitudine. ', 'immagini/22.jpg', 57, 12.5, 75, 'Piemonte ( Italia )', 'Vini Bianchi', 2023, '---');

-- VINI ROSE
INSERT INTO prodotto (nome, prezzo, iva, descrizione, immagine, stock, alcol, formato, provenienza, tipologia, annata, denominazione)
VALUES
("Tinetta La Bollina 2023", 9.90, 22, "Tinetta è un vino rosato leggero e delicato del Piemonte a base di Nebbiolo, vinificato e affinato in solo acciaio. Il ventaglio olfattivo verte su piccoli frutti rossi e fiori di campo con leggeri ricordi minerali.", 'immagini/23.jpg', 60, 13.0, 75, "Piemonte (Italia)", 'Vini Rosati', 2023, "Monferrato DOC"),
("Rosato 'Cancelli' Rabasco", 12.90, 22, "Un vino rosato fresco e succoso a base di uve rosse realizzato dalla cantina Rabasco sita nel territorio collinare del pescarese. Al naso profuma di rosa, melograno e intense sensazioni di frutti di bosco.", 'immagini/24.jpg', 107, 11.5, 75, "Abruzzo (Italia)", 'Vini Rosati', 2018, "---"),
("Rosato Massa Vecchia 2021", 44.00, 22, "Il Rosato di Massa Vecchia è un meraviglioso vino rosato a base di uve Malvasia Nera e Merlot in grado di esprimere l'anima autentica e tipica delle colline Metallifere dell'Alta Maremma", 'immagini/25.jpg', 37, 14.5, 75, "Toscana (Italia)", 'Vini Rosati', 2021, "Toscana IGT"),
("Rosé Chateau de Pibarnon 2022", 51.00, 22, "Il Rosé dello Chateau de Pibarnon è un vino rosato dal timbro fragrante, mediterraneo e solare prodotto a Bandol, famosa area di produzione di Rosé della Costa Azzurra. ", 'immagini/26.jpg', 61, 13.5, 75, "Provenza ( Francia )", 'Vini Rosati', 2022, "---"),
("Primitivo Rosato Doppio Passo 2023", 7.90, 22, "Il Primitivo Rosato Doppio Passo è un vino rosato del Salento che esprime grande freschezza e leggerezza di beva.  All'assaggio è slanciato, gentile e fragrante, con piacevole morbidezza che richiama un nuovo sorso", 'immagini/27.jpg', 56, 12.0, 75, "Puglia (Italia)", 'Vini Rosati', 2023, "Puglia IGT"),
("Derthona Vigneti Massa 2022", 21.00, 22, "Il Derthona di Vigneti Massa è un vino bianco espressivo e molto territoriale prodotto da uve bianche. Il profilo aromatico è floreale e agrumato, caratterizzato da grande freschezza e mineralità. ", 'immagini/28.jpg', 60, 14.0, 75, "Piemonte ( Italia )", 'Vini Rosati', 2022, "---"),
("Malvasia Zidarich 2021", 27.50, 22, "La Malvasia di Zidarich è un vino bianco intenso e territoriale, ricco di frutta, spezie ed erbe aromatiche. Viene prodotto in tini aperti con macerazione sulle bucce e matura in botte per 24 mesi. Esprime buona complessità, freschezza e sapidità", 'immagini/29.jpg', 47, 13.0, 75, "Friuli Venezia Giulia ( Italia )", 'Vini Rosati', 2021, "Venezia Giulia IGT"),
...
INSERT INTO prodotto (nome, prezzo, iva, descrizione, immagine, stock, alcol, formato, provenienza, tipologia, annata, denominazione)
VALUES
("Spumante Metodo Classico Extra Brut 'Quattrocento 40 Lune' Nicola Gatta", 33.50, 22, "Il 'Quattrocento' di Nicola Gatta è uno Spumante Metodo Classico che matura sui lieviti per 40 mesi/lune. ", 'immagini/37.jpg', 50, 12.5, 75, 'Lombardia (Italia)', 'Spumanti', 2019, '---'),
("Prosecco di Valdobbiadene Superiore", 11.50, 22, "descrizione", 'immagini/38.jpg', 50, 11.5, 75, 'Veneto (Italia)', 'Spumanti', 2023, 'Prosecco di V.-C. DOCG'),
("Brut 'Cuvée dei Frati' Ca' dei Frati", 17.90, 22, "Uno spumante metodo classico a base di Turbiana e Chardonnay che sosta almeno 24 mesi sui lieviti. Il bouquet presenta note biscottate di nocciola, fieno e tabacco stagionato, mentre in bocca è setoso e di bella freschezza", 'immagini/39.jpg', 50, 13.0, 75, 'Lombardia (Italia)', 'Spumanti', 2019, '---'),
("Trento Spumante Dosaggio Zero Tenuta Volpare 2019", 30.90, 22, "Il Trento Spumante Dosaggio Zero della Tenuta Volpare è uno spumante Metodo Classico a base di Pinot Nero e Chardonnay affinato 26 mesi sui lieviti. Un pas dosé che per questo resta secco ed equilibrato", 'immagini/40.jpg', 50, 12.5, 75, 'Trentino (Italia)', 'Spumanti', 2019, 'Trento DOC'),
